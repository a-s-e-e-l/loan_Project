            ...
            <ul class="navbar-nav float-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right  animated bounceInDown"
                            ...
                            <form action="{{URL('lang')}}" method="post">
                                ...
                                @foreach(config('app.languages') as $langLocale => $langName)
                                    <button class="dropdown-item" type="submit" value="{{$langLocale}}"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                       ...
                       aria-expanded="false">
                        <img src="{{asset('assets/images/login/logo.png')}}" alt="user" class="rounded-circle"
                             width="31">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            <div class="">
                                <img src="{{asset('assets/images/login/logo-icon.png')}}" alt="user" class="img-circle"
                                     width="60">
                            </div>
                            <div class="m-l-10">
                                @if( auth()->check() )
                                ...
                                @else
                                    {
                                    <h4 class="m-b-0">{{ __('dashboard.user')}}</h4>
                                    <p class=" m-b-0">{{ __('dashboard.email')}}</p>
                                    }
                                @endif
